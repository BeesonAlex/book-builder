    ...
    render() {
        ...
        return (
            <div className="bookhome">
                ...
                <button onClick={this.onClickHandler} className="bookhome__button--add-page btn--secondary"><img className="icon" src="https://cdn.shopify.com/s/files/1/0262/0584/7649/files/plus-circle.svg?58" />Add a Page</button>
                <button onClick={this.onSaveHandler} className="bookhome__button--save-book btn--secondary"><img className="icon" src="https://cdn.shopify.com/s/files/1/0262/0584/7649/files/save.svg?58" />Save Book</button>
                </div>
                </div>
